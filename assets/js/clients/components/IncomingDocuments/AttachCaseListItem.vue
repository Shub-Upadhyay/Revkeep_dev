				...
				<b-card v-if="hasRequests" no-body>
					...
					<b-list-group v-for="index in request_name.length" :key="index" flush >
						...
						<b-list-group-item v-if="request_appeal_level[index-1]==0" class="shadow-sm">
							...
							<b-form-group label="Decision"  label-cols-lg="4">
						...
						<b-list-group-item  class="shadow-sm">
							<b-row>
								<b-col cols="8" md="6" lg="12" xl="6" class="text-left mb-2 mb-md-0">
									...
									<!-- <b-form-group label="Decision"  label-cols-lg="4">
												<b-form-select  class="mt-1">
													<option value="Issues">Favourable</option>
													<option value="No Findings">Not Favourable</option>
													<option value="No Findings">Partially Favourable</option>
												</b-form-select>
									</b-form-group> -->
									<div id="decision-form">
										<b-form-group label="Decision" label-cols-lg="4">
											<b-form-select class="mt-1" id="decision-select">
											<option value="Issues">Favourable</option>
											<option value="Not Favourable">Not Favourable</option>
											<option value="Partially Favourable">Partially Favourable</option>
											</b-form-select>
										</b-form-group>

										<!-- This div will be initially hidden and will contain the "Amount" input -->
										<div id="amount-input" style="display: none;">
											<b-form-group label="Amount" label-cols-lg="4">
											<b-form-input class="mt-1" type="text" name="amount" id="amount">
											</b-form-input>
											</b-form-group>
										</div>
									</div>
...
export default {
	...
	methods: {
      ...
      decisionSelect.addEventListener("change", () => {
        if (decisionSelect.value === "Partially Favourable") {
    ...
    try {
	  ...
	  // Call the method to toggle the "Amount" input visibility
